// [생성물] lib/tipping-point.ts 의 복제본 + r 주입 훅 하나.
...
> = {
  // 포유류 — 큰 개체 / 늦은 성숙
  포유류: { generation_time: 8, r_max: 0.05, ne_nc: 0.2 },
  // 조류 — 중간
  조류: { generation_time: 5, r_max: 0.1, ne_nc: 0.25 },
  // 파충류 — 늦은 성숙, 긴 수명
  파충류: { generation_time: 10, r_max: 0.06, ne_nc: 0.15 },
  // 양서류 — 빠른 세대
  양서류: { generation_time: 3, r_max: 0.25, ne_nc: 0.1 },
  // 어류 — 매우 빠른 번식 가능
  "어류 (조기어류)": { generation_time: 4, r_max: 0.3, ne_nc: 0.1 },
  "어류 (경골어류)": { generation_time: 4, r_max: 0.3, ne_nc: 0.1 },
  "어류 (연골어류)": { generation_time: 12, r_max: 0.05, ne_nc: 0.1 },
  어류: { generation_time: 5, r_max: 0.2, ne_nc: 0.1 },
  곤충: { generation_time: 1, r_max: 0.5, ne_nc: 0.05 },
  거미류: { generation_time: 2, r_max: 0.4, ne_nc: 0.05 },
  갑각류: { generation_time: 2, r_max: 0.35, ne_nc: 0.05 },
  복족류: { generation_time: 2, r_max: 0.3, ne_nc: 0.05 },
  이매패류: { generation_time: 5, r_max: 0.15, ne_nc: 0.05 },
  "산호류 (육방산호)": { generation_time: 10, r_max: 0.05, ne_nc: 0.05 },
  // 식물
  "식물 (침엽수)": { generation_time: 30, r_max: 0.02, ne_nc: 0.1 },
  "식물 (소철)": { generation_time: 25, r_max: 0.03, ne_nc: 0.1 },
  "식물 (쌍떡잎)": { generation_time: 8, r_max: 0.1, ne_nc: 0.1 },
  양치식물: { generation_time: 5, r_max: 0.15, ne_nc: 0.1 },
  "양치식물 (속새류)": { generation_time: 5, r_max: 0.15, ne_nc: 0.1 },
  "이끼류 (우산이끼)": { generation_time: 2, r_max: 0.3, ne_nc: 0.1 },
  지의류: { generation_time: 10, r_max: 0.03, ne_nc: 0.1 },
};
